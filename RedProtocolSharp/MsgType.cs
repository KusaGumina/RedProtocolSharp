...
public class MsgType
{
        ...
        : Payload
    {
        ...
        public MessageInfo GetMessageInfo()
        {
            ...
            {
                messageInfo.ChatType = data[0].chatType;
                messageInfo.Uin = data[0].senderUin;
                messageInfo.SenderName = data[0].sendMemberName;
                messageInfo.PeerUin = data[0].peerUin;
                messageInfo.PeerName = data[0].peerName;
                messageInfo.Time = DateTimeOffset.FromUnixTimeSeconds(long.Parse(data[0].msgTime)).DateTime;
                messageInfo.MsgId = data[0].msgId;
                messageInfo.ReplayMsgSeq = data[0].msgSeq;
            }
            return messageInfo;
        }
        //获取消息相关信息
    ...
    public class Elements
    {
        ...
        public object? multiForwardMsgElement { get; set; }
        public object? pttElement { get; set; }
